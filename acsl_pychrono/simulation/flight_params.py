...
class FlightParams:
  def __init__(self):
    ...
    self.force_1_5_pos = chrono.ChVector3d(-0.08760601358, -0.0085, -0.10859150436)
    # position wrt local frame of where to apply the thrust force generated by motors 2 & 6 
    self.force_2_6_pos = chrono.ChVector3d(0.08812691616, -0.0085, -0.10834502049) 
    # position wrt local frame of where to apply the thrust force generated by motors 3 & 7
    self.force_3_7_pos = chrono.ChVector3d(0.08760601358, -0.0085, 0.10859150436) 
    # position wrt local frame of where to apply the thrust force generated by motors 4 & 8
    self.force_4_8_pos = chrono.ChVector3d(-0.08812691616, -0.0085, 0.10834502049) 
